...
function Navbar({ onOpenPalette }) {
  return (
    <motion.nav 
      ...
      className="fixed top-6 left-1/2 -translate-x-1/2 z-50 flex items-center justify-center px-6 py-3 bg-neutral-950 border border-neutral-800 rounded-full"
    >
      <div className="flex items-center justify-center gap-4 md:gap-8 text-sm font-mono text-neutral-400">
        ...
        <a href="/suryanshu-saini-resume.pdf" download className="bg-neutral-900 border border-neutral-800 px-5 py-2 rounded-full hover:border-neutral-400 hover:text-white transition-all duration-300 font-semibold tracking-wide ml-2 sm:ml-0">
          Resume
        </a>
      </div>
    </motion.nav>
