...
function Hero() {
  return (
    <section id="home" className="min-h-[80vh] flex items-center justify-center section-container pt-32 pb-16">
      ...
      >
        <p className="text-neutral-400 font-mono mb-6 text-sm md:text-lg tracking-wide">
          Hi, my name is
        </p>
        ...
        <p className="text-base sm:text-lg md:text-xl text-neutral-400 max-w-2xl mx-auto mb-12 leading-relaxed">
